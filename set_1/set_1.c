...
int challenge_2() {
    ...
    size_t bytes_1_len = 0;
    size_t bytes_2_len = 0;
...
int challenge_3() {
    ...
    for(size_t i = 0; i < strlen((const char *)letters); i++){
...
int challenge_6() {
    ...
    for(size_t i = 0; i < keysize; i++) {
        for(size_t j = 0; j < (2875 / keysize); j++){
    ...
    for(size_t i = 0; i < keysize; i++) {
        ...
        size_t bytes_len = 2875 / keysize;
        size_t score = 0;

        for (size_t a = 0; a < (2875 / keysize); a++){
        ...
        for(size_t j = 0; j < 64; j++){
            ...
            for (size_t k = 0; k < (2875 / keysize); k++){
                if(out_bytes[k] == ' ') {
                    char_score++;
                }
...
int challenge_8() {
    ...
    while ((read = getline(&line, &len, fp)) != -1) {
        ...
        for(size_t i = 0; i < bytes_len / 16; i++){
        ...
        for(size_t i = 0; i < 10; i++) {
            for(size_t j = 0; j < 10; j++) {
                bool match = true;
                if(i != j) {
                    for(size_t k = 0; k < 16 && match == true; k++) {
    ...
    printf("Challenge 8 ECB line = %lu\n", line_num);
    return 0;
}
